...
namespace Substrate.NodeTemplate.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1)));
        }
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> State(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            var result = await _client.GetStorageAsync<Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            var result = await _client.GetStorageAsync<Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The current list of authorities.
        /// </summary>
        public async Task<Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1> Authorities(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.AuthoritiesParams();
            var result = await _client.GetStorageAsync<Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Substrate.NodeTemplate.NET.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
