...
namespace Substrate.NodeTemplate.NET.RestClient.Generated.Clients
{
   ...
   public sealed class GrandpaControllerClient : BaseClient, IGrandpaControllerClient
   {
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "grandpa/setidsession", Substrate.NodeTemplate.NET.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SubscribeSetIdSession(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Grandpa.SetIdSession", Substrate.NodeTemplate.NET.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
